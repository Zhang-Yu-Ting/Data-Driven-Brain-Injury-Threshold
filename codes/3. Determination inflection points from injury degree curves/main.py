...
file_name1 = path + '\\' + 'fitting_results_all' + '_' + str(thres_range_min) + '_' + str(thres_range_max)
file_name2 = path + '\\' + 'inflection_points_all_for_plot' + '_' + str(thres_range_min) + '_' + str(thres_range_max)
